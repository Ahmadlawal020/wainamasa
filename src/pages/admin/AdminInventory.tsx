...
//   TrendingUp,
// } from "lucide-react";
// import { useGetProductsQuery } from "../../services/api/productsApiSlice"; // <- Make sure the path matches your project
...
//               <div className="ml-4">
//                 <p className="text-sm font-medium text-neutral-600">Critical</p>
//                 <p className="text-2xl font-bold text-neutral-900">
//                   {criticalItems}
//                 </p>
//               </div>
