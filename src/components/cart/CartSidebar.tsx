      ...
      <div className="h-full flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6">
          <div className="text-center">
            ...
            <p className="text-neutral-500 mb-6">Add delicious items to get started!</p>
            <SheetClose asChild>
              <Button asChild>
      ...
      <ScrollArea className="flex-1 p-6">
        <div className="space-y-4">
          {items.map((item, index) => {
            ...
            return (
              <div key={`${item.product.id}-${packageId || index}`} className="flex items-start space-x-4 pb-4 border-b">
                ...
                <div className="flex-1">
                  <div className="flex justify-between">
                    ...
                    <Button
                      variant="ghost"
                      size="icon"
                      onClick={() => removeFromCart(item.product.id, packageId)}
                    >
...
// This component is used in the CartSidebar when the cart is empty
