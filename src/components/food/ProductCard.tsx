...
//           <h3 className="text-lg md:text-xl font-bold menu-item-title mb-2 line-clamp-1">{product.name}</h3>
//         </div>
...
//               <span>
//                 <span className="text-green-500 font-normal mr-1 text-sm">From</span>
